...
function NamingExperimentSection() {
    ...
    const desktopWhileThese = (
        <TransformingTextBox doubled positions={[127, 27, 27, 27]} scrollInfo={adjustedTimings[11][0]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[11][0]} backY={12} fadeOut={false} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[70, 50]} rotate={0} />} />
                <div>
    ...
    const desktopTryThis01 = (
        <TransformingTextBox doubled positions={[27, 27, 27, -100]} scrollInfo={adjustedTimings[11][1]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[11][1]} backY={12} fadeIn={false} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[70, 50]} rotate={0} />} />
    ...
    const desktopToKeep = (
        <TransformingTextBox doubled positions={[27, 27, 27, 27]} scrollInfo={adjustedTimings[18][2]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[18][2]} backY={12} fadeIn={false} fadeOut={false} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[70, 50]} rotate={0} />} />
                <div>
    ...
    const desktopTryThis02 = (
        <TransformingTextBox doubled positions={[27, 27, 27, -100]} scrollInfo={adjustedTimings[18][3]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[18][3]} backY={12} fadeIn={false} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[70, 50]} rotate={0} />} />
