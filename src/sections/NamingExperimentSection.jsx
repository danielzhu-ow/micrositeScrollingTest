...
function NamingExperimentSection() {
    ...
    const desktopOff = (
        <>
            <TransformingContent child={<ImgBox url={getImageByKey("duracell")} displayDimensions={[26, 26]} rotate={-48} />} positions={[[1, 1, 1, 1], [-100, 5, 5, -100]]} scrollInfo={adjustedTimings[1][0]} alignment={['left', 'bottom']} />
            <TransformingContent child={<ImgBox url={getImageByKey("off")} displayDimensions={[20, 87]} rotate={10} />} positions={[[1, 1, 1, 1], [-100, 5, 5, -100]]} scrollInfo={adjustedTimings[1][0]} alignment={['right', 'bottom']} />
        </>
    )
    ...
    const desktopTheOpportunity = (
        <TransformingTextBox positions={[27, 27, 27, -100]} scrollInfo={adjustedTimings[4][2]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[4][2]} child={<ImgBox url={getImageByKey("tin_robot3")} displayDimensions={[18, 50]} rotate={0} />} />
                <div>
    ...
    const desktopWhileThese = (
        <TransformingTextBox positions={[127, 27, 27, 27]} scrollInfo={adjustedTimings[11][0]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[11][0]} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[18, 50]} rotate={0} />} />
                <div>
    ...
    const desktopTryThis01 = (
        <TransformingTextBox positions={[127, 27, 27, 27]} scrollInfo={adjustedTimings[11][1]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[11][1]} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[18, 50]} rotate={0} />} />
    ...
    const desktopWeFound = (
        <TransformingTextBox positions={[127, 10, 10, 10]} scrollInfo={adjustedTimings[18][0]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[18][0]} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[18, 50]} rotate={0} />} />
                <div>
    ...
    const desktopButChallenges = (
        <TransformingTextBox positions={[127, 10, 10, 10]} scrollInfo={adjustedTimings[18][1]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[18][1]} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[18, 50]} rotate={0} />} />
                <div>
    ...
    const desktopTryThis02 = (
        <TransformingTextBox positions={[127, 10, 10, 10]} scrollInfo={adjustedTimings[18][2]} alignment={'top'} child={
            <DoubleColumn>
                <ColumnImage scrollInfo={adjustedTimings[18][2]} child={<ImgBox url={getImageByKey("cute_robot")} displayDimensions={[18, 50]} rotate={0} />} />
    ...
    return (
        <div style={{ position: "relative", height: "100%", width: "100%" }}>
            ...
            <TransitionBackground background={getImageByKey("experiment_01")} height={sectionHeights[2]} startHeight={sectionHeights[0] + sectionHeights[1]} endOpacity={0.8} hasTransition={true} />
            ...
            <TransitionBackground background={getImageByKey("experiment_02")} height={sectionHeights[5]} startHeight={sectionHeights.slice(0, 5).reduce((partialSum, a) => partialSum + a, 0)} endOpacity={0.8} hasTransition={true} />
            ...
            <TransitionBackground background={getImageByKey("experiment_03")} height={sectionHeights[12]} startHeight={sectionHeights.slice(0, 8).reduce((partialSum, a) => partialSum + a, 0)} endOpacity={0.8} hasTransition={true} />
