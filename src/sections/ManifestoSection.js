...
function ManifestoSection({ images }) {
    ...
    const sectionTimings = [
        ...
        // 0 Avocado_toast        1 Avocado_1             2 Avocado_2            3 Avocado_3             4 Avocado_4             5 Header Paragraph        6 Paragraph 1           7 Paragraph 2          8 Paragraph 3         9 Galileo             10 1-2 Trans Timings    11 Para 4            12                   13 Mobile Avocado Op
        [[0.25, 0.3, 0.35, 0.4], [0.2, 0.3, 0.35, 0.45], [0.2, 0.3, 0.35, 0.45], [0.2, 0.3, 0.35, 0.45], [0.25, 0.3, 0.35, 0.4], [-0.05, 0.08, 0.12, 0.2], [0.2, 0.25, 0.4, 0.6], [0.2, 0.4, 0.6, 0.65], [0.55, 0.6, 0.8, 1], [0.7, 0.75, 0.85, 0.9], [0.2, 0.25, 0.55, 0.6], [0.6, 0.8, 0.95, 1], [0.55, 0.6, 0.9, 1], [0.25, 0.25, 0.4, 0.6]],
