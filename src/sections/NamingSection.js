...
function NamingSection({ images, text }) {
    ...
    const sectionTimings = [
        ...
        [0, 0.6]],                                    // [2] Img 2
        // [1] Section 1
        [[0, 0.25, 0.30, 0.4],                     // [0] Verizon    
        [0, 0.25, 0.30, 0.4],                      // [1] Sprite             
        ...
        [0.35, 0.4, 0.7],                     // [6] Dino Night            
        [0.6, 0.7, 0.9]],                       // [7] Dino Day 
        ...
        [
            ...
            [0, 0.2, 0.99, 1],                      // [1] post video paragraph
            [0, 0.8, 1],
        ],
    ...
    const mobileSection1 = (
        <>
            ...
            <TransformingContent child={<ImgBox url={images.dino_night} displayDimensions={[50, 50]} rotate={0} />}
                //          [0.35, 0.475, 0.6, 0.65]
                positions={[[100, 100, -150], [-2, -2, -2]]} scrollInfo={adjustedTimings[1][6]} alignment={['left', 'bottom']} prioritizeHeight={true} />
            <TransformingContent child={<ImgBox url={images.dino_day} displayDimensions={[50, 50]} rotate={0} />}
                //          [0.35, 0.475, 0.6, 0.65]
                positions={[[100, 100, -200], [0, 0, 0]]} scrollInfo={adjustedTimings[1][7]} alignment={['left', 'bottom']} prioritizeHeight={true} />
        </>
    );
    const desktopSection1 = (
        <>
            ...
            <TransformingContent child={<ImgBox url={images.dino_night} displayDimensions={[70, 70]} rotate={0} />}
                //          [0.35, 0.475, 0.6, 0.65]
                positions={[[100, 35, -100], [0, 0, 0]]} scrollInfo={adjustedTimings[1][6]} alignment={['left', 'bottom']} prioritizeHeight={true} />
            <TransformingContent child={<ImgBox url={images.dino_day} displayDimensions={[70, 70]} rotate={0} />}
                //          [0.35, 0.475, 0.6, 0.65]
                positions={[[100, 40, -100], [0, 0, 0]]} scrollInfo={adjustedTimings[1][7]} alignment={['left', 'bottom']} prioritizeHeight={true} />
        </>
    );
    ...
    const mobileVideo = (
        <>
            <TransformingContent child={<VideoBox url={namezap1} displayWidth={95} />}
                positions={[[0, 0, 0], [-100, 30, 30]]} scrollInfo={adjustedTimings[4][0]} alignment={['center', 'center']} />
        </>
    );
    ...
    const mobileVideoText01 = (
        <TransformingContent positions={[[0, 0, 0], [5, 5, 100]]} scrollInfo={adjustedTimings[5][3]} alignment={['center', 'center']}
            child={<VideoTextBox scrollInfo={adjustedTimings[5][0]} displayWidth={80} heightRatio={0.656} child={
                <VideoTextScroller scrollInfo={adjustedTimings[5][0]} scrollToFrom={[100, -100]}>
